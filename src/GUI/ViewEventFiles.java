 ...
 */
public class ViewEventFiles extends javax.swing.JFrame {

    /**
     * Creates new form AddEventDetails
     */
    public ViewEventFiles() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewEventFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewEventFiles().setVisible(true);
            }
        });
    }
