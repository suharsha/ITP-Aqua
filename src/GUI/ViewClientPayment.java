 ...
 */
public class ViewClientPayment extends javax.swing.JFrame {

    /**
     * Creates new form AddEventDetails
     */
    public ViewClientPayment() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewClientPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewClientPayment().setVisible(true);
            }
        });
    }
