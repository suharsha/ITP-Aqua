 ...
 */
public class EditEventFiles extends javax.swing.JFrame {

    /**
     * Creates new form AddEventDetails
     */
    public EditEventFiles() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditEventFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditEventFiles().setVisible(true);
            }
        });
    }
