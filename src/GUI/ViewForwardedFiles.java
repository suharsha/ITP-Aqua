 ...
 */
public class ViewForwardedFiles extends javax.swing.JFrame {

    /**
     * Creates new form AddEventDetails
     */
    public ViewForwardedFiles() {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Approved", "Disapproved" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewForwardedFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewForwardedFiles().setVisible(true);
            }
        });
    }
