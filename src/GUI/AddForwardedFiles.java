 ...
 */
public class AddForwardedFiles extends javax.swing.JFrame {

    /**
     * Creates new form AddEventDetails
     */
    public AddForwardedFiles() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddForwardedFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddForwardedFiles().setVisible(true);
            }
        });
    }
